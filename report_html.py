...
jacoco_command2 = jacoco_command2 + ' --html '
jacoco_output_dir = "result/report"

jacoco_command = jacoco_command1 + coverage_file + jacoco_command2 + jacoco_output_dir

print("Executing command:", jacoco_command)
